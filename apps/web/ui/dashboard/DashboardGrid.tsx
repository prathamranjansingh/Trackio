export default function DashboardGrid() {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-6 gap-4 w-full p-4">
      ...
      <div className="col-span-2 sm:col-span-2 md:col-span-2 row-span-2 bg-blue-500 min-h-[300px]">
        Stopwatch
      </div>
      ...
      {/* Location */}
      <div className="col-span-2 sm:col-span-1 md:col-span-1 bg-pink-500 min-h-[150px]">
        leetcode topics
      </div>
      {/* About */}
