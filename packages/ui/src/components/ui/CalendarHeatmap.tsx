...
function categorizeDatesPerVariant(
  ...
  const categorizedRecord: Date[][] = Array.from(
    { length: noOfVariants },
    () => []
  );
...
function CalendarHeatmap({
  ...
  const dates =
    datesPerVariant ?? categorizeDatesPerVariant(weighted, noOfVariants);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-[#595959] rounded-md w-9 font-normal text-[0.8rem]",
